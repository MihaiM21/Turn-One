  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background/95 via-background to-background/98">
      ...
      <div className="container mx-auto px-4 py-6 lg:px-8 lg:py-10">
        {/* Header Section */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-background/50 border border-primary/20 p-6 lg:p-8 mb-8">
          <div className="relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <div className="flex items-center gap-3 mb-3">
                  <div className="p-2 rounded-full bg-primary/20 backdrop-blur-md">
                ...
                <p className="text-sm text-muted-foreground">
                  Track your race predictions and performance statistics
                </p>
              </div>
              <Link href="/games">
          ...
          <div className="absolute top-0 right-0 w-1/3 h-full opacity-5">
            <Trophy className="absolute top-4 right-4 w-24 h-24" />
          </div>
        </div>
        ...
        <Card className="border-border/50 bg-background/30 backdrop-blur-md mb-6">
          <CardContent className="pt-6">
            ...
            <CardContent className="flex flex-col items-center justify-center py-20">
              ...
              <p className="text-sm text-muted-foreground mb-6 max-w-md text-center">
                {filter === 'all' 
                  ...
                  : `No ${filter} predictions found. Try another filter or make a new prediction.`
                }
              </p>
              <Link href="/games">
                <Button size="lg" className="gap-2">

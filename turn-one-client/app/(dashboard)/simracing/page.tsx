...
export default function SimracingLiveDashboard() {
    ...
    useEffect(() => {
        ...
        const handleSessionEnd = () => setIsActive(false);
        ...
        simTelemetryService.connect(); // Connect as owner
        ...
        <div className="relative w-full min-h-screen p-6 bg-gradient-to-br from-black via-red-950/20 to-black font-sans text-white">
            ...
            <div className="container mx-auto px-4 py-8 space-y-8 max-w-7xl">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-black italic tracking-tight text-white">LIVE COCKPIT</h1>
                        <p className="text-muted-foreground font-medium">Player: <span className="text-white">{staticInfo?.playerName || "---"}</span></p>
                    </div>

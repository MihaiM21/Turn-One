...
export const grandPrixCalendar: Record<string, Record<string, GrandPrix[]>> = {
  ...
  "2026": {
    races: [
      ...
      { id: "4", name: "Bahrain Grand Prix", shortName: "BHR", country: "Bahrain", circuit: "Bahrain International Circuit" },
      { id: "5", name: "Saudi Arabian Grand Prix", shortName: "SAU", country: "Saudi Arabia", circuit: "Jeddah Corniche Circuit" },
      { id: "6", name: "Miami Grand Prix", shortName: "MIA", country: "USA", circuit: "Miami International Autodrome" },
      { id: "7", name: "Canadian Grand Prix", shortName: "CAN", country: "Canada", circuit: "Circuit Gilles-Villeneuve" },
      { id: "8", name: "Monaco Grand Prix", shortName: "MON", country: "Monaco", circuit: "Circuit de Monaco" },
      { id: "9", name: "Gran Premio de Barcelona-Catalunya", shortName: "ESP", country: "Spain", circuit: "Circuit de Barcelona-Catalunya" },
      ...
      { id: "12", name: "Belgian Grand Prix", shortName: "BEL", country: "Belgium", circuit: "Spa-Francorchamps" },
      { id: "13", name: "Hungarian Grand Prix", shortName: "HUN", country: "Hungary", circuit: "Hungaroring" },
      { id: "14", name: "Dutch Grand Prix", shortName: "NED", country: "Netherlands", circuit: "Zandvoort Circuit" },
      { id: "15", name: "Italian Grand Prix", shortName: "ITA", country: "Italy", circuit: "Monza Circuit" },
      { id: "16", name: "Spanish Grand Prix", shortName: "MAD", country: "Spain", circuit: "Madring" },
      { id: "17", name: "Azerbaijan Grand Prix", shortName: "AZE", country: "Azerbaijan", circuit: "Baku City Circuit" },
      { id: "18", name: "Singapore Grand Prix", shortName: "SGP", country: "Singapore", circuit: "Marina Bay Street Circuit" },
      { id: "19", name: "USA Grand Prix", shortName: "USA", country: "USA", circuit: "Circuit of the Americas" },
      { id: "20", name: "Mexico City Grand Prix", shortName: "MEX", country: "Mexico", circuit: "Autódromo Hermanos Rodríguez" },
      { id: "21", name: "São Paulo Grand Prix", shortName: "BRA", country: "Brazil", circuit: "Interlagos Circuit" },
      { id: "22", name: "Las Vegas Grand Prix", shortName: "LAS", country: "USA", circuit: "Las Vegas Street Circuit" },
      { id: "23", name: "Qatar Grand Prix", shortName: "QAT", country: "Qatar", circuit: "Lusail International Circuit" },
      { id: "24", name: "Abu Dhabi Grand Prix", shortName: "ABU", country: "UAE", circuit: "Yas Marina Circuit" }
    ]
  }
